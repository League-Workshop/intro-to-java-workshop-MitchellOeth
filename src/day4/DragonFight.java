...
public class DragonFight {
	...
	public static void main(String[] args) {
		...
		while (playerHealth > 0 && dragonHealth > 0) { // this line of code keeps the battle going until someone's
			...
			// or a kick
			String attack = JOptionPane.showInputDialog(null, "Will you attack the dragon with a yell or a kick?");
			// 9. If they typed in "yell":
			Random damage = new Random();
			if (attack.equals("yell")) {
				// -- Find a random number between 0 and 10 and store it in dragonDamage
				dragonDamage = damage.nextInt(11);
			...
			if (attack.equals("kick")) {
				...
				dragonDamage = damage.nextInt(26);
				// -- Subtract that number from the dragon's health variable
				dragonHealth = dragonHealth - dragonDamage;

				// 11. Find a random number between 0 and 35 and store it in playerDamage
				playerDamage = damage.nextInt(36);
